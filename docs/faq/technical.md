...
Learn more about [the different components](../overview/What's%20backstage/what-is-backstage.md) that
make up Backstage.
...
[Phase 2](../overview/Roadmap/roadmap.md) of the project we will add features that are
